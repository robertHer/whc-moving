<?php
/**
 * whc-underscores functions and definitions
 *
...
if ( ! function_exists( 'whc_setup' ) ) :
	...
	function whc_setup() {
		 ...
		 * If you're building a theme based on whc-underscores, use a find and replace
...
function whc_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'whc' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'whc' ),
